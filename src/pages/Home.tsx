  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 mb-12">
        ...
        >
          <Link to={heroArticle.slug ? `/news/${heroArticle.slug}` : `/article/${heroArticle.id}`} className="block relative overflow-hidden bg-zinc-100 dark:bg-zinc-900 h-[450px] lg:h-[600px] rounded-3xl shadow-2xl">
            <img 
        ...
        <div className="lg:col-span-4 flex flex-col gap-6">
          {secondaryArticles.map((article, idx) => (
            <motion.div
              ...
              className="h-full"
            >
              <Link to={article.slug ? `/news/${article.slug}` : `/article/${article.id}`} className="group flex flex-col h-full bg-white dark:bg-zinc-900 border border-zinc-100 dark:border-zinc-800 hover:shadow-lg transition-all duration-300 rounded-2xl overflow-hidden">
          ...
          <div className="lg:col-span-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
              {gridArticles.map((article, idx) => (
                ...
                >
                  <Link to={article.slug ? `/news/${article.slug}` : `/article/${article.id}`} className="group flex flex-col h-full">
