            ...
            <div className="sticky top-8 space-y-6">
              ...
              <div className="bg-white p-6 rounded-2xl border border-zinc-200 shadow-sm">
                ...
                <div className="space-y-5">
                  ...
                  <div>
                    <label className="block text-sm font-bold text-zinc-700 mb-1.5">Article Slug (URL)</label>
                    <input 
                      type="text"
                      value={formData.slug}
                      onChange={e => setFormData({...formData, slug: e.target.value})}
                      className="w-full px-4 py-2.5 bg-zinc-50 border border-zinc-200 rounded-xl focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all outline-none font-mono text-xs"
                      placeholder="article-slug-here"
                      required
                    />
                    <p className="text-[10px] text-zinc-400 mt-1 font-medium">Used in URL: /news/{formData.slug || '...'}</p>
                  </div>
