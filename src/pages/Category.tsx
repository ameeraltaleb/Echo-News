      ...
      {articles.length === 0 ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
          {articles.map((article, idx) => (
            ...
            >
              <Link to={article.slug ? `/news/${article.slug}` : `/article/${article.id}`} className="group flex flex-col bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 hover:shadow-2xl transition-all duration-500 rounded-2xl overflow-hidden h-full">
